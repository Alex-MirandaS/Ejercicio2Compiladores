...
// source: /home/alex/Documents/Proyectos/Ejercicio/Ejercicio2Compi/src/main/java/Recursos/Ejercicio2.jflex
...
public class Ejercicio2 {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\60\0\12\1\7\0\32\2\6\0\32\2\126\0\1\2"+
    "\37\0\1\2\u010e\0";
...
return numeros;
   ...
   */
  public Ejercicio2(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 4: break;
          case 2:
            { lexema= "valor: " + yytext()+"columna: "+yycolumn+" fila: "+yyline; añadirNumero(lexema);
            }
            // fall through
          case 5: break;
          case 3:
            { lexema=yytext(); contarVocales(lexema);
            }
            // fall through
          case 6: break;
          default:
